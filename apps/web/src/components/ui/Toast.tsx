...
import { generateId } from '@forky/shared'
import { ToastContainer } from '@forky/ui'
import type { ToastVariant } from '@forky/ui'
...
export function ToastProvider({ children }: { children: ReactNode }) {
  const [toasts, setToasts] = useState<Array<{ id: string; variant: ToastVariant; message: string; duration?: number }>>([])
