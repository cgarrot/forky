...
import { guestStartApi, loginApi } from '@forky/state'
...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = err instanceof Error && err.message ? err.message : 'An error occurred during login'
      setError(message)
    } finally {
      setIsLoading(false)
    }
  ...
  const handleGuestMode = async () => {
    ...
    try {
      const data = await guestStartApi()
      ...
      const message =
        err instanceof Error && err.message ? err.message : 'An error occurred while starting guest mode'
